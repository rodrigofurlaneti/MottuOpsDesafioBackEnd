...
using MottuOpsDesafioBackEnd.Test.UnitTest.Helpers;
...
namespace MottuOpsDesafioBackEnd.Test.UnitTest.WebApplication.Controllers
{
    public class AuthenticationControllerTests
    {
        ...
        public async Task Dashboard_ShouldSaveAuthResponseInSession_AndReturnView_WhenAuthenticationSucceeds()
        {
            ...
            var savedAuthResponse = JsonSerializer.Deserialize<AuthenticationResponse>(Encoding.UTF8.GetString(sessionValue));
